...
if uploaded_file and model_file:
    ...
    if enable_sensitivity:
        ...
        for params in param_grid:
            ...
            max_drawdown = (1 - min(portfolio_values) / max(portfolio_values)) * 100
        ...
        drawdown_pivot = results.pivot(index='MA', columns='RSI', values='Max Drawdown (%)')
        plt.figure(figsize=(10, 6))
        ...
        def portfolio_rebalance(df, initial_balance=10000, stop_loss=0.05, take_profit=0.15, frequency='Weekly'):
            ...
            holdings = 0
            portfolio_values = []
            rebalance_days = {"Daily": 1, "Weekly": 5, "Monthly": 20}
        ...
        if optimize_allocation:
            ...
            portfolio_values, final_value = portfolio_rebalance(df, initial_balance=10000, stop_loss=stop_loss,
                                                                 take_profit=take_profit, frequency=rebalance_frequency)
